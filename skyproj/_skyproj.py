...
class _Skyproj():
    ...
    def draw_pixel_boundaries(self, nside, indices, text=False, color="gray", facecolor="none",
        ...
        for i in indices:
            ...
            if text:
                _ra, _dec = hpg.pixel_to_angle(nside, i)
                self._ax.text(_ra, _dec, i, lonlat=True, ha='center', va='center', clip_on=True, color=color,
                              **kwargs)
